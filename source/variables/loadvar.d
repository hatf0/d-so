...
void loadimmed_uint(ref decompiler dec) {
	import std.conv : to;
	dec.stacks.i_s ~= to!string(dec.fi.code[dec.i]);
	dec.i++;
}

void loadimmed_str(ref decompiler dec) {
	import std.string;
